...
public partial class EmployeesPage : ContentPage
{
    ...
    private async void PickTextFileButton_Clicked(object sender, EventArgs e)
    {
        try
        {
            FilePickerFileType textFileTypes = new(new Dictionary<DevicePlatform, IEnumerable<string>>
            {
    ...
    private async void PickImageButton_Clicked(object sender, EventArgs e)
    {
        ...
        {
            await DisplayAlert(title:"Exception", message: "Photo was null.", cancel: "OK");
        }
    }
    ...
    private async void TakeAscreenshotButton_Clicked(object sender, EventArgs e)
    {
        if (Screenshot.Default.IsCaptureSupported)
        {
            IScreenshotResult photo = await Screenshot.Default.CaptureAsync();
